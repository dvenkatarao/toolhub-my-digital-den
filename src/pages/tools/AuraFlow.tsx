...
// Separate component for the breathing tool functionality
function AuraFlowBreathingTool() {
  return (
    <div className="auraflow-container">
        ...
        <section className="controls">
          <div className="panel actions">
            ...
            <div className="toggles">
              <label className="toggle"><input type="checkbox" id="soundToggle" defaultChecked /> Sound</label>
          ...
          <div className="panel">
            ...
            <div className="slider">
              ...
              <input id="durationSlider" type="range" min="1" max="20" step="1" defaultValue="4" />
            </div>
          </div>
        </section>
      ...
      <style jsx>{`
        .auraflow-container {
          ...
          --text: hsl(210 40% 98%);
          --muted: hsl(215 20% 65%);
          --ring-track: rgba(241, 245, 249, 0.1);
          --outline: rgba(241, 245, 249, 0.12);
          --inhale: hsl(173 80% 40%);
          --exhale: hsl(252 95% 85%);
          --hold: hsl(38 92% 50%);
        }
